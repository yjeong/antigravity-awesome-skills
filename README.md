<!-- registry-sync: version=9.11.0; skills=1399; stars=31821; updated_at=2026-04-09T18:03:14+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,399+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,399+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,399+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,399+ skills", start with a tool-specific guide:
