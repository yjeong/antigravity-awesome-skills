...
※ 오케스트레이터는 위 실행 뼈대를 준수하되, 작업 전반에 걸쳐 장기 기억/맥락 유지(context7)와 단계별 논리 추론(sequential-thinking), 논문 작성시 유용한 도구 (arXiv MCP, Local Research MCP, Google Cloud Data MCP, Filesystem MCP 등)를 충돌없이 임의로 상시 가동한다.
